{ config, pkgs, lib, ...}: {
  ...
  programs.neovim = {
    ...
    plugins = with pkgs.vimPlugins; [
      ...
      { plugin = nvim-hlslens; optional = false; }
      { plugin = nvim-scrollbar; optional = false; }
      ...
      { plugin = vim-airline; optional = false; }
      { plugin = vim-airline-themes; optional = false; }

      {
        plugin = nvim-treesitter.withAllGrammars;
        optional = false;
      }
      { plugin = playground; optional = false; }
